...
const CreditsPanel = ({ onClose }) => {
  return /* @__PURE__ */ jsxDEV("div", { className: "fixed inset-0 z-50 flex items-center justify-center", children: [
    ...
    /* @__PURE__ */ jsxDEV(
      "div",
      {
        className: "relative bg-gray-900 text-white border-2 border-yellow-600 rounded-xl shadow-2xl overflow-hidden w-[95vw] max-w-[720px] h-[80vh]",
        role: "dialog",
        "aria-modal": "true",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxDEV("div", { className: "p-5 h-[calc(80vh-56px)] overflow-y-auto space-y-6", children: [
